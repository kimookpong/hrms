                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="card">
                                <div class="card-body w_sparkline">
                                    <div class="details">
                                        <span>คำร้องขอเอกสารทั้งหมด</span>
                ...
                <div class="container-fluid">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="Employee-list" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">คำร้องขอเอกสารที่รอดำเนินการ</h3>
                                    <div class="card-options">
                                        <form>
                                        ...
                                        <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="HRMS_admin_req_form.php" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> รายระเอียด</a>
                                                    </td>
                                                </tr>
