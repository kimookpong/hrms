                ...
                <div class="container-fluid">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="Employee-list" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">มีความประสงค์ขอหนังสือรับรองดังนี้</h3>
                                    <div class="card-options">
                                    </div>
                                </div>
                                <div class="card-body row">
                                    <div class="col-md-4 col-lg-4">
                                        <label class="custom-control custom-checkbox">
                                            <br> <input type="checkbox" class="custom-control-input" name="example-checkbox2" value="option2">
                                            <span class="custom-control-label">1. หนังสือรับรองเงินเดือน</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="example-text-input" placeholder="ฉบับ..">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label class="form-label">วัตถุประสงค์ในการขอเพื่อ</label>
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <label class="custom-control custom-checkbox ">
                                            <br> <input type="checkbox" class="custom-control-input" name="example-checkbox2" value="option2">
                                            <span class="custom-control-label">2 . หนังสือรับรองการเป็นพนักงาน</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <label class="custom-control custom-checkbox ">
                                            <br> <input type="checkbox" class="custom-control-input" name="example-checkbox2" value="option2">
                                            <span class="custom-control-label">3 . หนังสือรับรองการผ่านงาน (กรณีลาออกจากการเป็นพนักงาน)</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-8 col-lg-8">
                                        <label class="custom-control custom-checkbox ">
                                            <br> <input type="checkbox" class="custom-control-input" name="example-checkbox2" value="option2">
                                            <span class="custom-control-label">4.หนังสือรับรองเงินเดือนเพื่อประกอบการกู้สวัสดิการเคหะสงเคราะห์ของธนาคารอาคารสงเคราะห์(หักบัญชีผ่านมหาวิทยาลัย)</span>
                                        </label>
                                    </div>
                                ...
                                <div class="card-footer text-right">
                                    <a href="HRMS_1_6_user_req.php" class="btn btn-danger"><i class="fa fa-close"></i> ย้อนกลับ</a>
                                    <a href="HRMS_1_6_user_req.php" class="btn btn-primary"><i class="fa fa-save"></i> บันทึกข้อมูล</a>
