            ...
            <div id="page_top" class="section-body ">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">คำร้องขอแก้ไขข้อมูลส่วนตัว</h1>
                        </div>
                        <div class="right">
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <ul class="nav nav-tabs page-header-tab">
                            <li class="nav-item"><a class="nav-link active" id="Employee-tab" data-toggle="tab" href="#Employee-list">สำหรับบุคลากร</a></li>
                        </ul>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <a href="HRMS_1_13_personal_req_form_1.php">
                                <div class="card text-center bg-orange">
                                    <div class="card-body text-light">
                                        <div class="content">
                                            <div class="text">แจ้งความประสงค์</div>
                                            <h5 class="number">เปลี่ยนคำนำหน้า ชื่อ-สกุล</h5>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a href="HRMS_1_13_personal_req_form_2.php">
                                <div class="card text-center bg-orange">
                                    <div class="card-body text-light">
                                        <div class="content">
                                            <div class="text">แจ้งความประสงค์</div>
                                            <h5 class="number">แก้ไขข้อมูลคู่สมรส</h5>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="HRMS_1_13_personal_req_form_3.php">
                                <div class="card text-center bg-orange">
                                    <div class="card-body text-light">
                                        <div class="content">
                                            <div class="text">แจ้งความประสงค์</div>
                                            <h5 class="number">เปลี่ยนสถานภาพ</h5>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a href="HRMS_1_13_personal_req_form_4.php">
                                <div class="card text-center bg-orange">
                                    <div class="card-body text-light">
                                        <div class="content">
                                            <div class="text">แจ้งความประสงค์</div>
                                            <h5 class="number">แก้ไขข้อมูลบุคร</h5>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="HRMS_1_13_personal_req_form_5.php">
                                <div class="card text-center bg-orange">
                                    <div class="card-body text-light">
                                        <div class="content">
                                            <div class="text">แจ้งความประสงค์</div>
                                            <h5 class="number">เปลี่ยนวุฒิการศึกษา</h5>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a href="HRMS_1_13_personal_req_form_6.php">
                                <div class="card text-center bg-orange">
                                    <div class="card-body text-light">
                                        <div class="content">
                                            <div class="text">แจ้งความประสงค์</div>
                                            <h5 class="number">แก้ไขข้อมูลที่อยู่</h5>
                                        </div>
                                    </div>
                                </div>
                            </a>
                ...
                <div class="container-fluid">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="Employee-list" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">คำร้องขอปรับปรุงข้อมูลส่วนตัวของฉัน</h3>
                                    <div class="card-options">
                                        <form>
                                        ...
                                        <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:40%;">แจ้งความประสงค์</th>
                                                    <th style="width:15%;">วันที่ส่งคำขอ</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><span>เปลี่ยนคำนำหน้า ชื่อ-สกุล</span></td>
                                                    <td>7 ธ.ค. 2563</td>
                                                    <td><span class="tag tag-orange">ยื่นคำร้อง</span></td>

                                                    <td>
                                                        <button type="button" class="btn btn-secondary btn-sm" title="View"><i class="fa fa-eye"></i></button>
                                                        <button type="button" class="btn btn-danger js-sweetalert btn-sm" title="ยกเลิก" data-type="confirm"><i class="fa fa-trash-o"></i></button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td><span>แก้ไขข้อมูลที่อยู่</span></td>
                                                    <td>7 ธ.ค. 2563</td>
                                                    <td><span class="tag tag-green">อนุมัติ</span></td>

                                                    <td>
                                                        <button type="button" class="btn btn-secondary btn-sm" title="View"><i class="fa fa-eye"></i></button>
                                                        <button type="button" class="btn btn-link btn-sm" title="View" disabled><i class="fa fa-trash-o"></i></button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td><span>แก้ไขข้อมูลคู่สมรส</span></td>
                                                    <td>7 ธ.ค. 2563</td>
                                                    <td><span class="tag tag-red">ไม่อนุมัติ</span></td>
