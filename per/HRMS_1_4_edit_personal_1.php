            ...
            <div class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">แก้ไขข้อมูลบุคลากร</h1>
                        </div>
                        <div class="right">
                ...
                <div class="container-fluid">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media mb-4">
                                        ...
                                        <div class="media-body">
                                            <div class="content">
                                                <span><strong>รหัสพนักงาน: </strong> 2020012200001</span>
                                                <p class="h5">นายฮากิม มูดอ</p>
                                                <p>เจ้าหน้าที่วิเคราะห์ระบบฯ ศูนย์เทคโนโลยีดิจิทัล</p>
                                                <small>เริ่มงานวันที่ 7 ธ.ค. 2563</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-tabs">
                                    <a href="HRMS_1_4_edit_personal_1.php" class="card-tabs-item text-center active">
                                        <div class="mb-1">ข้อมูลส่วนตัว</div>
                                    </a>
                                    <a href="HRMS_1_4_edit_personal_2.php" class="card-tabs-item text-center">
                                        <div class="text-muted-dark">ข้อมูลครอบครัว</div>
                                    </a>
                                    <a href="HRMS_1_4_edit_personal_3.php" class="card-tabs-item text-center">
                                        <div class="text-muted-dark">ข้อมูลการศึกษาและประสบการณ์</div>
                                    </a>
                                    <a href="HRMS_1_4_edit_personal_4.php" class="card-tabs-item text-center">
                                        <div class="text-muted-dark">ข้อมูลเพิ่มเติม</div>
                                    </a>
                                </div>
                                <div class="card-body row">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">รูปที่ใช้ในราชการ <small>รองรับไฟล์ภาพ png,jpg,jpeg,gif</small></h3>
                                            </div>
                                            <div class="card-body">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="example-text-input" value="นราธิวาส">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select">
                                                <option value="STATUS_CODE">พุทธ</option>
                                                <option value="JSON_BODY" selected>อิสลาม</option>
                                ...
                                <div class="card-body row">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label class="form-label">ที่อยู่</label>
                                            <input type="text" class="form-control" name="example-text-input" value="73 หมู่ 6">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select">
                                                ...
                                                <option value="นครศรีธรรมราช" selected>นครศรีธรรมราช </option>
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label">อำเภอ</label>
                                            <select class="custom-select">
                                                <option value="" selected>ท่าศาลา</option>
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label">รหัสไปรษณีย์</label>
                                            <input type="text" class="form-control" name="example-text-input" value="80160">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control phone-number" value="0936027014">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control phone-number" value="kimookpong@gmail.com">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control phone-number" value="www.kimookpong.com">
                                            </div>
                                        </div>
                                    </div>
                                </div>
