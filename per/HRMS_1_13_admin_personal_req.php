            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" id="Employee-tab" data-toggle="tab" href="#Employee-list">รายการที่รอดำเนินการ</a> <span class="badge badge-danger">6</span></li>
                        <li class="nav-item"><a class="nav-link" id="Employee-tab" data-toggle="tab" href="#Employee-Request">ทั้งหมด </a></li>
                    </ul>
            ...
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="Employee-list" role="tabpanel">                        
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">คำร้องขอที่รอดำเนินการ</h3>
                                <div class="card-options">
                                    <form>
                                    ...
                                    <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:35%;">แจ้งความประสงค์</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>ศูนย์เทคโนโลยีดิจิตอล</td>
                                                <td><span>เปลี่ยนคำนำหน้า ชื่อ-สกุล</span></td>
                                                <td>7 ธ.ค. 2563</td>
                                                
                                                <td><span class="tag tag-orange">ยื่นคำร้อง</span></td>
                                                <td>
                                                    <a href="HRMS_admin_req_form.php"><button type="button" class="btn btn-primary btn-sm" title="รายระเอียด"><i class="fa fa-edit"></i></button></a>
                                                    <button type="button" class="btn btn-info btn-sm" title="อนุมัติ"><i class="fa fa-check"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm" title="ไม่อนุมัติ"><i class="fa fa-close"></i></button>
                                                </td>
                                            </tr>
