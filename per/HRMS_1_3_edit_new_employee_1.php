                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-tabs">
                                    <a href="HRMS_1_3_edit_new_employee_1.php" class="card-tabs-item text-center active">
                                        <div class="mb-1">ข้อมูลส่วนตัว</div>
                                    </a>
                                    <a href="HRMS_1_3_edit_new_employee_2.php" class="card-tabs-item text-center">
                                        <div class="text-muted-dark">ข้อมูลครอบครัว</div>
                                    </a>
                                    <a href="HRMS_1_3_edit_new_employee_3.php" class="card-tabs-item text-center">
                                        <div class="text-muted-dark">ข้อมูลการศึกษาและประสบการณ์</div>
                                    </a>
                                    <a href="HRMS_1_3_edit_new_employee_4.php" class="card-tabs-item text-center">
