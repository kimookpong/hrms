            ...
            <div class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">เพิ่มวีซ่าสำหรับบุคลากรต่างชาติ (Work permit)</h1>
                        </div>
                        <div class="right">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="form-label">ค้นหาบุคลากรต่างชาติ</label>
                                        <div class="row gutters-xs">
                                            <div class="col">
                                                <input type="text" id="idcar" class="form-control">
                                            </div>
                                            <span class="col-auto"><button class="btn btn-primary" type="button"><i class="fe fe-search"></i> ค้นหา</button></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
