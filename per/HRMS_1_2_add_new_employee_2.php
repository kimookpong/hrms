                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-tabs">
                                    ...
                                    <a href="HRMS_1_2_add_new_employee_2.php" class="card-tabs-item text-center active">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลบิดา</h3>
                                </div>
                                <div class="card-body row">
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select">
                                                <option value="" selected="">ยังมีชีวิต</option>
                                                <option value="">เสียชีวิตแล้ว</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลมารดา</h3>
                                </div>
                                <div class="card-body row">
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลคู่สมรส</h3>
                                </div>
                                <div class="card-body row">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" name="gender" value="female" data-parsley-multiple="gender">
                                                <span class="custom-control-label">หม้าย</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" name="gender" value="female" data-parsley-multiple="gender">
                                                <span class="custom-control-label">หย่า</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" name="gender" value="female" data-parsley-multiple="gender">
                                                <span class="custom-control-label">แยกกันอยู่</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลบุตร</h3>
                                </div>
                                <div class="card-body">
