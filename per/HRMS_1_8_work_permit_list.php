        ...
        <div id="page_top" class="section-body ">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        <h1 class="page-title">รายการวีซ่าบุคลากรต่างชาติ</h1>                   
                    </div>
                    <div class="right">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="card">
                            <div class="card-body w_sparkline">
                                <div class="details">
                                    <span">วิซ่ากำลังจะหมดภายใน 90 วัน</span>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="card">
                            <div class="card-body w_sparkline">
                                <div class="details">
                                    <span>วิซ่ากำลังจะหมดภายใน 30 วัน</span>
                                    ...
                                    <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>พนักงาน</th>
                                                <th>หน่วยงาน</th>
                                                <th>วันออกใบอนุญาต</th>
                                                <th>วันสิ้นสุดใบอนุญาต</th>
                                                <th>สิ้นสุดภายใน(วัน)</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>7 ธ.ค. 2563</td>
                                                <td>7 ธ.ค. 2563</td>
                                                <td><span class="tag tag-success">132</span></td>
                                                <td>
                                                    <a href="HRMS_1_8_work_permit_edit.php"><button type="button" class="btn btn-primary btn-sm" title="แก้ไข"><i class="fa fa-edit"></i></button></a>
