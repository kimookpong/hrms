...
<body class="font-montserrat sidebar_dark">
    ...
    <div id="main_content">
        ...
        <div class="user_div">
            <h5 class="brand-name mb-4">Epic HR<a href="javascript:void(0)" class="user_btn"><i
                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="row gutters-xs">
                                            ...
                                            <span class="col-auto"><button class="btn btn-primary" type="button"><i
                                                        class="fe fe-search"></i> ตรวจสอบข้อมูล</button></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-tabs">
                                    <a href="HRMS_1_2_add_new_employee_1.php" class="card-tabs-item text-center ">
                                    ...
                                    <a href="HRMS_1_2_add_new_employee_4.php" class="card-tabs-item text-center active">
                                        <div class="text-muted-dark">ข้อมูลเพิ่มเติม (ไม่บังคับ)</div>
                                    </a>
                                </div>
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลผู้ติดต่อฉุกเฉิน</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    <th style="width:10%;" class="pl-0">คำนำหน้า</th>
                                                    <th style="width:15%">ชื่อ</th>
                                                    <th style="width:15%">ชื่อกลาง (ถ้ามี)</th>
                                                    <th style="width:15%">นามสกุล</th>
                                                    <th style="width:20%">เบอร์โทรติดต่อ/อิเมล</th>
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลบุคคลอ้างอิง</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลใบประกอบวิชาชีพ</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    <th style="width:30%;" class="pl-0">ชื่อใบประกอบ</th>
                                                    <th style="width:30%">เลขที่ใบประกอบ</th>
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลคะแนนภาษาอังกฤษ</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    <th style="width:30%;" class="pl-0">ชุดทดสอบ</th>
                                                    <th style="width:30%">จำนวนคะแนน</th>
                                                    <th style="width:15%">วันออกใบอนุญาต</th>
                                                    <th style="width:15%">วันสิ้นสุดใบอนุญาต</th>
                                                    <th style="width:5%">ไฟล์</th>
                                                    <th style="width:5%" class="pr-0"><button class="btn btn-primary" type="button">เพิ่ม</button></th>
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลผู้พิการ</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    <th style="width:25%;" class="pl-0">ประเภทความพิการ</th>
                                            ...
                                            <tr>
                                                <td class="pl-0">
                                                    <select class="custom-select">
                                                        <option value="ความพิการทางการเห็น ">ความพิการทางการเห็น </option>
                                                        <option value="ความพิการทางการได้ยินหรือสื่อความหมาย">ความพิการทางการได้ยินหรือสื่อความหมาย</option>
                                                        <option value="ความพิการทางการเคลื่อนไหวหรือทางร่างกาย ">ความพิการทางการเคลื่อนไหวหรือทางร่างกาย </option>
                                                        <option value="ความพิการทางจิตใจหรือพฤติกรรม  ">ความพิการทางจิตใจหรือพฤติกรรม  </option>
                                                        <option value="ความพิการทางสติปัญญา  ">ความพิการทางสติปัญญา  </option>
                                                        <option value="ความพิการทางการเรียนรู้  ">ความพิการทางการเรียนรู้  </option>
                                                        <option value="ความพิการทางออทิสติก ">ความพิการทางออทิสติก </option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ประวัติการฝึกอบรม/ดูงาน ทั้งในและต่างประเทศ</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    <th style="width:25%;" class="pl-0">หลักสูตร/เรื่อง</th>
                                                    <th style="width:30%">สถานที่</th>
                                                    <th style="width:15%">ระยะเวลา พ.ศ.</th>
                                                    <th style="width:20%">แหล่งทุน</th>
                                                    <th style="width:5%" class="pr-0"><button class="btn btn-primary" type="button">เพิ่ม</button></th>
                                                </tr>
                                            </thead>
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">รางวัลความดีความชอบพิเศษ หรือเกียรติคุณอื่นๆ ที่ได้รับ</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    <th style="width:30%;" class="pl-0">ชื่อรางวัล</th>
                                                    <th style="width:40%">แหล่งที่มอบ</th>
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ความรู้ ความสามารถ หรือความชำนาญพิเศษ</h3>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">งานอดิเรก</h3>
                                </div>
                                <div class="card-body">
                                    <textarea class="summernote">
                                    </textarea>
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ประสบการณ์ในการเป็นอาจารย์ที่ปรึกษาวิทยานิพนธ์ระดับบัณฑิตศึกษา</h3>
                                </div>
                                <div class="card-body">
                                    <textarea class="summernote">
                                    </textarea>
