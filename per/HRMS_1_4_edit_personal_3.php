                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-tabs">
                                    ...
                                    <a href="HRMS_1_4_edit_personal_3.php" class="card-tabs-item text-center active">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    <th style="width:15%;" class="pl-0">ระดับการศึกษา</th>
                                                    <th style="width:30%">สถานศึกษา</th>
                                                    <th style="width:20%">วุฒิการศึกษา</th>
                                            ...
                                            <tr>
                                                <td class="pl-0">
                                                    <select class="custom-select">
                                                        <option value="มัธยมศึกษา" selected>มัธยมศึกษา</option>
                                                        <option value="ปวช" selected>ปวช</option>
                                                        <option value="ปวส" selected>ปวส</option>
                                                        <option value="อนุปริญญา" selected>อนุปริญญา</option>
                                                        <option value="ปริญญาตรี" selected>ปริญญาตรี</option>
                                                        <option value="ปริญญาโท" selected>ปริญญาโท</option>
                                                        <option value="ปริญญาเอก" selected>ปริญญาเอก</option>
                                                    </select>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <select class="custom-select">
                                                        <option value="การศึกษาบัณฑิต" selected>การศึกษาบัณฑิต</option>
                                                        <option value="การออกแบบอุตสาหกรรมบัณฑิต" selected>การออกแบบอุตสาหกรรมบัณฑิต</option>
                                                        <option value="เกษตรศาสตรบัณฑิต" selected>เกษตรศาสตรบัณฑิต</option>
                                                        <option value="ครุศาสตรบัณฑิต" selected>ครุศาสตรบัณฑิต</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" value="2561">
                                                </td>
                                                <td>
                                                    <select class="custom-select">
                                                        <option value="ไทย" selected>ไทย</option>
                                                        <option value="ยุโรป" selected>ยุโรป</option>
                                                        <option value="ยูเอส" selected>ยูเอส</option>
                                                    </select>
                                                </td>
                                                <td>
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ประสบการณ์ทำงาน</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    <th style="width:15%;" class="pl-0">ตำแหน่ง</th>
                                                    <th style="width:20%">บริษัท/สำนักงาน</th>
                                                    <th style="width:20%">ระหว่าง</th>
                                            ...
                                            <tr>
                                                <td class="pl-0">
                                                    <input type="text" class="form-control" value="โปรแกรมเมอร์">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" value="บริษัท ซีตี้วาไรตี้ จำกัด">
                                                </td>
                                                <td>
                                                    <div class="input-daterange input-group">
                                                        <input type="text" class="input-sm form-control" name="start" value="2555">
                                                        <span class="input-group-addon range-to">ถึง</span>
                                                        <input type="text" class="input-sm form-control" name="end" value="2559">
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" value="ทำเว็บโดยใช้ CI และเป็นหัวหน้าแผนกโปรแกรมเมอร์">
                                                </td>
                                                <td class="pr-0">
                                                    <button type="button" class="btn btn-icon js-sweetalert" title="Delete" data-type="confirm"><i class="fa fa-trash-o text-danger"></i></button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="pl-0">
                                                    <input type="text" class="form-control" value="ผู้จัดการโรงงาน">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" value="บริษัท ออตโตมันเอ็นเตอร์ไพรส์ จำกัด">
                                                </td>
                                                <td>
                                                    <div class="input-daterange input-group">
                                                        <input type="text" class="input-sm form-control" name="start" value="2559">
                                                        <span class="input-group-addon range-to">ถึง</span>
                                                        <input type="text" class="input-sm form-control" name="end" value="2563">
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" value="ควบคุมการผลิตและนำนวัตกรรมมาใช้ในการคอนโทรล">
                                                </td>
                                                <td class="pr-0">
                                                    <button type="button" class="btn btn-icon js-sweetalert" title="Delete" data-type="confirm"><i class="fa fa-trash-o text-danger"></i></button>
                                                </td>
