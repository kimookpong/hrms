                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media mb-4">
                                ...
                                <div class="media-body">
                                    <div class="content">
                                        <span><strong>REQ ID: </strong> 2020012200001</span>
                                        <p class="h5">นายฮากิม มูดอ <small class="float-right badge badge-primary">07 มกราคม 2563</small></p>
                                        <p>เจ้าหน้าที่วิเคราะห์ระบบฯ ศูนย์เทคโนโลยีดิจิทัล</p>
                                        <div class="float-right text-right"> <select class="custom-select">
                                                <option selected="">อยู่ระหว่างดำเนินการ</option>
                                                <option value="1">ดำเนินการเสร็จสิ้นแล้ว</option>
                                            </select></div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-vcenter">
                                    <thead class="dark-mode">
                                        <tr>
                                            <th style="width:5%;">#</th>
                                            <th style="width:40%;">เอกสาร</th>
                                            <th style="width:10%;">ภาษาไทย</th>
                                            <th style="width:10%;">ภาษาอังกฤษ</th>
                                            <th style="width:30%;">วัตถุประสงค์/เอกสารแนบ</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>02</td>
                                            <td>
                                                <span>หนังสือรับรองการเป็นพนักงาน</span>
                                            </td>
                                            <td>2</td>
                                            <td>-</td>
                                            <td>กู้เงิน</td>
                                        ...
                                        <tr>
                                            <td>03</td>
                                            <td>
                                                <span>หนังสือรับรองการผ่านงาน (กรณีลาออกจากการเป็นพนักงาน)</span>
                                            </td>
                                            <td>-</td>
                                            <td>1</td>
                                            <td>กู้เงิน</td>
                                        ...
                                        <tr>
                                            <td>04</td>
                                            <td>
                                                <span>หนังสือรับรองเงินเดือนเพื่อประกอบการกู้สวัสดิการเคหะสงเคราะห์ของธนาคารอาคารสงเคราะห์(หักบัญชีผ่านมหาวิทยาลัย)</span>
                                            </td>
                                            <td>1</td>
                                            <td>-</td>
                                            <td>กู้เงิน</td>
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="HRMS_admin_req.php" class="btn btn-primary"><i class="fa fa-save"></i> บันทึกข้อมูล</a>
                                    <a href="HRMS_admin_req.php" class="btn btn-danger"><i class="fa fa-close"></i> ยกเลิก</a>
                                </div>
                            </div>
                        </div>
                    </div>
