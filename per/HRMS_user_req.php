            ...
            <div id="page_top" class="section-body ">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">คำร้องขอเอกสาร</h1>
                        </div>
                        <div class="right">
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="header-action">
                            <a href="HRMS_user_req_form.php">
                                <button type="button" class="btn btn-primary"><i class="fe fe-plus mr-2"></i>บันทึกใบคำร้องขอเอกสาร</button>
                            </a>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="container-fluid">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="Employee-list" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">คำร้องขอเอกสารของฉัน</h3>
                                    <div class="card-options">
                                        <form>
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm" placeholder="ค้นหา" name="s">
                                        ...
                                        <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:30%;">แจ้งความประสงค์</th>
                                                    <th style="width:5%;">ไทย</th>
                                                    <th style="width:5%;">อังกฤษ</th>
                                                    <th style="width:10%;">วันที่ส่งคำขอ</th>
                                                ...
                                                <tr>
                                                    <td class="d-flex">
                                                        ...
                                                        <div class="ml-3">
                                                            ...
                                                            <span class="text-muted">เจ้าหน้าที่วิเคราะห์ระบบ</span>
                                                        </div>
                                                    </td>
                                                    <td><span>หนังสือรับรองเงินเดือน</span></td>
                                                    <td>✓</td>
                                                    <td></td>
                                                    <td>7 ธ.ค. 2563</td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-secondary btn-sm" title="View"><i class="fa fa-eye"></i> รายระเอียด</button>
                                                        <button type="button" class="btn btn-danger js-sweetalert btn-sm" title="ยกเลิก" data-type="confirm"><i class="fa fa-close"></i> ยกเลิก</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td><span>หนังสือรับรองการเป็นพนักงาน</span></td>
                                                    <td>✓</td>
                                                    <td></td>
                                                    <td>7 ธ.ค. 2563</td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-secondary btn-sm" title="View"><i class="fa fa-eye"></i> รายระเอียด</button>
                                                        <button type="button" class="btn btn-link btn-sm" title="View" disabled><i class="fa fa-close"></i> ยกเลิก</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td><span>หนังสือรับรองการผ่านงาน</span></td>
                                                    <td>✓</td>
                                                    <td>✓</td>
                                                    <td>7 ธ.ค. 2563</td>
