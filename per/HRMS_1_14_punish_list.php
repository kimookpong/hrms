        ...
        <div id="page_top" class="section-body ">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        <h1 class="page-title">รายการประวัติโทษทางวินัย</h1>                   
                    </div>
                    <div class="right">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <div class="ml-3">
                                                        <h6 class="mb-0">ฮากิม มูดอ</h6>
                                                        <span class="text-muted">เจ้าหน้าที่วิเคราะห์ระบบ</span>
                                                    </div>
                                                </td>
                                                <td><span>ศูนย์เทคโนโลยีดิจิตอล</span></td>
                                                <td>7 ธ.ค. 2563</td>
                                                <td><span class="tag tag-success">กำลังรับพิจารณา</span></td>
                                                <td>
                                                    <a href="HRMS_1_8_work_permit_edit.php"><button type="button" class="btn btn-primary" title="แก้ไข"><i class="fa fa-edit"></i></button></a>
