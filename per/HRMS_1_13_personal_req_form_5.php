                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">มีความประสงค์ต้องการแก้ไขข้อมูลคู่สมรส</h3>
                                </div>
                                <div class="card-body row">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label class="form-label">คู่สมรสมีสิทธิ์เบิกสวัสดิการ (เช่น ค่ารักษาพยาบาล ค่าเล่าเรียนบุตร)</label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                ...
                                                <span class="custom-control-label">ไม่มีสิทธิ์</span>
                                            </label>

                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" name="gender" value="female" data-parsley-multiple="gender">
                                                <span class="custom-control-label">มีสิทธิ์ จาก</span>
                                            </label>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="text" class="form-control" name="example-text-input" placeholder="Text.."></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
