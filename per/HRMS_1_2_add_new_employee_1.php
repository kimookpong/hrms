            ...
            <div class="section-body">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="left">
                            <h1 class="page-title">เพิ่มพนักงานใหม่</h1>
                        </div>
                        <div class="right">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ตรวจสอบข้อมูล?</h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="form-label">เลขประจำตัวประชาชน/เลขพาสพอร์ต</label>
                                        <div class="row gutters-xs">
                                            <div class="col">
                                                <input type="text" id="idcard" class="form-control">
                                            </div>
                                            <span class="col-auto"><button class="btn btn-primary" type="button"><i class="fe fe-search"></i> ตรวจสอบข้อมูล</button></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-tabs">
                                    <a href="HRMS_1_2_add_new_employee_1.php" class="card-tabs-item text-center active">
                                        <div class="mb-1">ข้อมูลส่วนตัว</div>
                                    </a>
                                    <a href="HRMS_1_2_add_new_employee_2.php" class="card-tabs-item text-center">
                                        <div class="text-muted-dark">ข้อมูลครอบครัว</div>
                                    </a>
                                    <a href="HRMS_1_2_add_new_employee_3.php" class="card-tabs-item text-center">
                                        <div class="text-muted-dark">ข้อมูลการศึกษาและประสบการณ์</div>
                                    </a>
                                    <a href="HRMS_1_2_add_new_employee_4.php" class="card-tabs-item text-center">
                                        <div class="text-muted-dark">ข้อมูลเพิ่มเติม (ไม่บังคับ)</div>
                                    </a>
                                </div>
                                <div class="card-body row">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">รูปประจำตัว <small>รองรับไฟล์ภาพ png,jpg,jpeg,gif</small></h3>
                                            </div>
                                            <div class="card-body">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select">
                                                <option value="STATUS_CODE" selected="">Mr.</option>
                                                <option value="JSON_BODY">Mrs.</option>
                                                <option value="HEADERS">Miss</option>
                                                <option value="TEXT_BODY">Ms.</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label">Middle Name (if any)</label>
                                            <input type="text" class="form-control" name="example-text-input" placeholder="Text..">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label">ภูมิลำเนา</label>
                                            <input type="text" class="form-control" name="example-text-input" placeholder="Text..">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select">
                                                <option value="STATUS_CODE" selected="">ชาย</option>
                                                <option value="JSON_BODY">หญิง</option>
                                                <option value="HEADERS">ไม่ระบุ</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select">
                                                <option value="">โอ</option>
                                                <option value="">เอ</option>
                                                <option value="">บี</option>
                                                <option value="">เอบี</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select">
                                                <option value="STATUS_CODE" selected="">พุทธ</option>
                                                <option value="JSON_BODY">อิสลาม</option>
                                                <option value="HEADERS">ครีสต์</option>
                                                <option value="TEXT_BODY">ยิว</option>
                                                <option value="RESPONSE_TIME">ซิกข์</option>
                                                <option value="">พราหมณ์-ฮินดู</option>
                                                <option value="">บาไฮ</option>
                                                <option value="">เชน</option>
                                                <option value="">โซโรอัสเตอร์</option>
                                                <option value="">ไม่นับถือศาสนา</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <div class="form-group multiselect_div">
                                            <label class="form-label">เชื่อชาติ</label>
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">กรณีต่างชาติ (Work permit)</h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <table class="table mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:5%" class="pr-0"><button class="btn btn-primary" type="button">เพิ่ม</button></th>
                                                </tr>
                                            </thead>
                                            <tr>
                                                <td class="pl-0">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลที่อยู่ตามทะเบียนบ้าน</h3>
                                </div>
                                <div class="card-body row">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select">
                                                <option value="">ขนอม</option>
                                                <option value="">จุฬาภรณ์</option>
                                                <option value="">เฉลิมพระเกียรติ (จังหวัดนครศรีธรรมราช)</option>
                                                <option value="">ฉวาง</option>
                                                <option value="">ชะอวด</option>
                                                <option value="">ช้างกลาง</option>
                                                <option value="">เชียรใหญ่</option>
                                                <option value="">ถ้ำพรรณรา</option>
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select">
                                                <option value="">ท่าศาลา</option>
                                                <option value="">กลาย</option>
                                                <option value="">ท่าขึ้น</option>
                                                <option value="">หัวตะพาน</option>
                                                <option value="">สระแก้ว</option>
                                                <option value="">โมคลาน</option>
                                                <option value="">ไทยบุรี</option>
                                                <option value="">ดอนตะโก</option>
                                                <option value="">ตลิ่งชัน</option>
                                                <option value="">โพธิ์ทอง</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลที่อยู่ปัจจุบัน</h3>
                                </div>
                                <div class="card-body row">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control phone-number" placeholder="+(66)0 99-999-999">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control phone-number" placeholder="+(66)0 99-999-9999">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control phone-number" placeholder="your-email@domain.com">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control phone-number" placeholder="www.domain.com">
                                            </div>
                                        </div>
                                    </div>
                                </div>
