        ...
        <div id="page_top" class="section-body ">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        <h1 class="page-title">ฟอร์มสำหรับบันทึกประเภทการลา</h1>                   
                    </div>
        ...
        <div class="section-body  mt-3">
            ...
            <div class="card">
                            ...
                            <div class="col-md-3 col-lg-3">
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label">บันทึกใบลาก่อนกี่วัน</label>
                                            <input type="text" class="form-control" name="example-text-input" placeholder=""> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label class="form-label">ลาสูงสุดได้กี่วันต่อปีงบประมาณ(ใช้เพื่อแจ้งเตือน)</label>
                                            <input type="text" class="form-control" name="example-text-input" placeholder="">
                                        </div>
                                    </div>
 </div>
                                    ...
                                    <a href="HRMS_admin_leave_type.php" class="btn btn-primary"><i class="fa fa-save"></i> บันทึกข้อมูล</a>
                                    <a href="HRMS_admin_leave_type.php" class="btn btn-danger"><i class="fa fa-close"></i> ยกเลิก</a>
                                    </div>
                                </div>
                            </div>                            
                        </div>
