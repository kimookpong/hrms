            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" id="Payroll-tab" data-toggle="tab" href="#Payroll-Salary">ตั้งค่ากำหนดกะเวลา</a></li>
                    </ul>
                    <div class="header-action">
                        <a type="button" class="btn btn-primary" href="HRMS_admin_timeworkplan_form.php"><i class="fe fe-plus mr-2"></i>Add</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table table-hover table-striped table-vcenter text-nowrap">
                                        <thead>
                                            <tr> 
                                                ...
                                                <th class="w60">ชื่อ</th>
                                                <th>ตัวย่อ</th>
                                                <th class="w200">เวลาเข้า</th>
                                                <th class="w60">เวลาออก</th>
