            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" id="Payroll-tab" data-toggle="tab" href="#Payroll-Salary">ตั้งค่ากำหนดกะเวลา+ตำแหน่ง</a></li>
                    </ul>
                    <div class="header-action">
                        <a type="button" class="btn btn-primary" href="HRMS_admin_timeworkplan_position_form.php"><i class="fe fe-plus mr-2"></i>Add</a>
                    </div>
                </div>
            </div>
        </div>
