            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" id="Payroll-tab" data-toggle="tab" href="#Payroll-Salary">ตั้งค่ากำหนดประเภทการลา</a></li>
                    </ul>
                    ...
                    <div class="tab-pane fade show active" id="Payroll-Salary" role="tabpanel">
                        <div class="row clearfix">
                            <div class="col-lg-3 col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                    <h6>รูปแบบการลาในระบบ</h6>
                                    <h1 class="pt-3"><span class="counter">5</span></h1>
