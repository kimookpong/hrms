            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" id="Payroll-tab" data-toggle="tab" href="#Payroll-Salary">ตั้งค่าสิทธิ์การใช้งานหน่วยงาน</a></li>
                    </ul>
                                    ...
                                    <table class="table table-hover table-striped text-nowrap">
                                        <thead>
                                            <tr> 
                                                ...
                                                <th class="w200">สิทธ์</th>
                                                <th class="w200">บุคลากร</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><span>02</span></td>
                                                <td>ผู้อนุมัติระดับผู้บริหาร </td>
                                                <td></td>
                                                <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">เพิ่ม</button>                                                </td>
                                            </tr> <tr>
                                                <td><span>03</span></td>
                                                <td>เลขาประจำหน่วยงาน</td>
                                                <td>....................	</td>
                                                <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">เพิ่ม</button>                                                   </td>
                                            </tr>                                   
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">กำหนดสิทธิการใช้งาน</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">  
                            <label >โมดูล</label>                                 
                            <input type="text" class="form-control" value="บันทึกการปฎิบัติงานและการลา	" readonly>
                        </div>
                        <div class="form-group">  
                            <label >สิทธิ์</label>                                 
                            <input type="text" class="form-control" value="ผู้อนุมัติระบบหัวหน้างาน	" readonly>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">                                   
