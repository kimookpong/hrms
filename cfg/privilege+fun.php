            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" id="Payroll-tab" data-toggle="tab" href="#Payroll-Salary">ตั้งค่าสิทธิ+ฟังชั่น</a></li>
                    </ul>
                        ...
                        <div class="card">
                           ...
                           <div class="input-group">  
                            ...
                            <option>เงินเดือน</option>
                                   ...
                                   <span class="input-group-btn ml-2"><button class="btn btn-info" type="submit"><span class="fe fe-search"></span></button></span>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-hover table-striped table-vcenter text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> - คำร้องขอลา	<br> - คำร้องขอลา<br> - คำร้องขอลา</td>
                                                <td>
                                                    <button type="button" class="btn btn-info"  data-toggle="tooltip" data-placement="top"  onclick="location.href='privilege+fun_form.php'">ตั้งค่าสิทธิ์</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><span>02</span></td>
