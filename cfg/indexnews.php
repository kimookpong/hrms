        ...
        <div class="section-body mt-3">
            <div class="container-fluid">
                <div class="row clearfix">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
											...
											<p class="mb-0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;มหาวิทยาลัยวลัยลักษณ์ประกาศแนวปฏิบัติการเฝ้าระวังการระบาดของโรคติดเชื้อไวรัสโคโรน่า 2019 (โควิด19) ฉบับที่ 3 รายละเอียดตามไฟล์แนบ</p><br>
                                           <p class="mb-0"><i class="fa fa-paperclip"></i> ไฟล์แนบเพิ่มเติม </p>
										   <p class="mb-0"><a href="#">1. ประกาศฉบับที่ 1</a></p>
										   <p class="mb-0"><a href="#">2. ประกาศฉบับที่ 2</a></p>
                                        </td>                                      
                                    </tr>
                        ...
                        <div class="card">
                        <div class="card-header">
                                <h3 class="card-title">ข้าวประกาศทั่วไป</h3>
                                <div class="card-options">
                                    <form>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover table-striped text-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <td><span>ประกาศ มวล.เรื่อง แนวปฏิบัติการเฝ้าระวังการระบาดของโรคติดเชื้อไวรัสโคโรน่า 2019 (โควิด19) ฉบับที่ <?php echo $y;?></span></td>
                                                <td><span><?php echo $d--?>/03/2564</span></td>
                                                <td>230</td>
