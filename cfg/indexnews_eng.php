                        ...
                        <div class="notification d-flex">
                            ...
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    ...
                                    <a href="javascript:void(0)" class="dropdown-item text-center text-muted-dark readall">Read more</a>
                                </div>
                            </div>
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="page-profile.html"><i class="dropdown-icon fe fe-user"></i> Edit profile</a>
        ...
        <div class="section-body mt-3">
            <div class="container-fluid">
                <div class="row clearfix">
                        ...
                        <div class="card">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p class="mb-0">Announcement of Walailak University on Suspension of Classes Due to the Spread of Covid-19</p>
											 <span class="text-muted font-13">Publish date: 12/03/2564 - Viewed : 230 </span>
											<p class="mb-0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Detail of Announcement of Walailak University on Suspension of Classes Due to the Spread of Covid-19</p><br>
                                           <p class="mb-0"><i class="fa fa-paperclip"></i> Attach files </p>
										   <p class="mb-0"><a href="#">1. Announcement 1</a></p>
										   <p class="mb-0"><a href="#">2. Announcement 2</a></p>
                                        </td>                                      
                                    </tr>
                        ...
                        <div class="card">
                        <div class="card-header">
                                <h3 class="card-title">Genearl Announcement</h3>
                                <div class="card-options">
                                    <form>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover table-striped text-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <td><span>Announcement of Walailak University on Suspension of Classes Due to the Spread of Covid-19  <?php echo $y;?></span></td>
                                                <td><span><?php echo $d--?>/03/2021</span></td>
                                                <td>230</td>
