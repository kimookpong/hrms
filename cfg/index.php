    ...
    <div class="auth">
        <div class="auth_left">
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="selectgroup w-100 col-8">
                            <label class="selectgroup-item">
                                <input type="radio" name="value" value="TH" class="selectgroup-input" checked="">
                                <span class="selectgroup-button">ภาษาไทย</span>
                            </label>
                            <label class="selectgroup-item">
                                <input type="radio" name="value" value="ENG" class="selectgroup-input">
                ...
                <div class="card-body">
                    <div class="card-title text-center">WU HRMS<br>Walailak Univesity</div>
                    <div class="form-group">
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="User account">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-footer">
                        <a href="index2.php" class="btn btn-primary btn-block" title="">Sign in</a>
                    </div>
                </div>
            </div>
        </div>
