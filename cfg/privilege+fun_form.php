    ...
    <div class="page">
        ...
        <div class="section-body  mt-3">
            ...
            <div class="card">
                            ...
                            <input type="text" class="form-control" name="example-checkbox2" value="การบันทึกปฎิบัติงานและการลา" readonly>
                            </div>  </div>

                            <div class="col-md-3 col-lg-3">
                                             <div class="form-group">
                                            <label class="form-label">สิทธิ์</label>
                                    <input type="text" class="form-control" name="example-checkbox2" value="ผู้อนุมัติระดับหน่วยงาน" readonly>
                            </div>  </div>
                           ...
                           <div class="col-md-2 col-lg-2">ฟังก์ชั่น</div>
                            ...
                            <option>7</option>
                            <option>8</option>
                        </select></th>                                              <th>บันทึกคำร้องขอปฏิบัติงานนอกเวลา	
</th>
                                            </tr>
                                            <tr>
                                              <th><input type="checkbox"> </th>
                            ...
                            <option>7</option>
                            <option>8</option>
                        </select></th>                                              <th>บันทึกคำร้องขอเบิกค่าตอบแทน OT	
</th>
                                            </tr>                                           
                                            </table>
