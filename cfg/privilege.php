                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <ul class="nav nav-tabs page-header-tab">
                            <li class="nav-item"><a class="nav-link active" id="Employee-tab" data-toggle="tab" href="#Employee-list"></a></li>
                            <li class="nav-item"><a class="nav-link" id="Employee-tab" data-toggle="tab" href="#Employee-view"></a></li>
                            <li class="nav-item"><a class="nav-link" id="Employee-tab" data-toggle="tab" href="#Employee-Request"></a></li>
                        </ul>
                        <div class="header-action">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fe fe-plus mr-2"></i>เพิ่ม</button>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>อัตรากำลัง</td>
                                                    <td>ผู้อนุมัติระบบหัวหน้างาน</td>
                                                    <td>Workforce Plan</td>
                                                    <td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เพิ่มสิทธิ์การใช้งาน</h5>
                ...
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                <select class="custom-select">
                                    <option value="">โมดูลอัตรากำลัง </option>
                                    <option value="POST">โมดูลสรรหาและคัดเลือก</option>
                                    <option value="PUT">โมดูลทะเบียนประวัติ</option>
                                    <option value="HEAD">โมดูลอัตรากำลัง</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Name_Eng">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
